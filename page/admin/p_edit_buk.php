...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			// simpan ke database
			mysql_query("UPDATE buku set judul='$judul',id_kategori='$id_kategori',pengarang='$pengarang',penerbit='$penerbit',hal='$halaman',harga='$harga',deskripsi='$deskripsi',gambar='$nama_file_baru' where id_buku='$id_buku'");
